class BlockController < ApplicationController
  def create
    ...
    if blocked_user
      ...
      redirect_to society_path(type: 'block'), success: "#{blocked_user.name} has been blocked!"
    else
  ...
  def destroy
    ...
    if blocked_user
      ...
      redirect_to society_path(type: 'block'), success: "#{blocked_user.name} has been unblocked!"
    else
      flash[:error] = "This user doesn't exist!"
      redirect_to society_path
    end
