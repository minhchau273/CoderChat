class FriendshipController < ApplicationController
  def create
    ...
    if new_friend
      ...
      redirect_to society_path, success: "#{new_friend.name} has been added to your friend list!"
    else
  ...
  def destroy
    ...
    if friend
      ...
      redirect_to society_path, success: "#{friend.name} has been removed from your friend list!"
    else
      flash[:error] = "This user doesn't exist!"
      redirect_to society_path
    end
